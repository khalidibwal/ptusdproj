...
<head>
    ...
    <body>
        ...
        @extends('Pumps.page.magnetic.component.content9')
        @extends('Pumps.page.magnetic.component.content8')
        @extends('Pumps.page.magnetic.component.content7')
        @extends('Pumps.page.magnetic.component.content6')
        @extends('Pumps.page.magnetic.component.content5')
        @extends('Pumps.page.magnetic.component.content4')
        @extends('Pumps.page.magnetic.component.content3')
        @extends('Pumps.page.magnetic.component.content2')
        @extends('Pumps.page.magnetic.component.content')
        @extends('Pumps.page.magnetic.component.header')
