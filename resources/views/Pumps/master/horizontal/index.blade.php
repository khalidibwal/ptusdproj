...
<head>
    ...
    <body>
        ...
        @extends('Pumps.page.horizontal.component.content8')
        @extends('Pumps.page.horizontal.component.content7')
        @extends('Pumps.page.horizontal.component.content6')
        @extends('Pumps.page.horizontal.component.content5')
        @extends('Pumps.page.horizontal.component.content4')
        @extends('Pumps.page.horizontal.component.content3')
        @extends('Pumps.page.horizontal.component.content2')
        @extends('Pumps.page.horizontal.component.content')
        @extends('Pumps.page.horizontal.component.header')
