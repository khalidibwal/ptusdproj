...
<head>
    ...
    <body>
        ...
        @extends('Pumps.page.api.component.content9')
        @extends('Pumps.page.api.component.content8')
        @extends('Pumps.page.api.component.content7')
        @extends('Pumps.page.api.component.content6')
        @extends('Pumps.page.api.component.content5')
        @extends('Pumps.page.api.component.content4')
        @extends('Pumps.page.api.component.content3')
        @extends('Pumps.page.api.component.content2')
        @extends('Pumps.page.api.component.content')
        @extends('Pumps.page.api.component.header')
