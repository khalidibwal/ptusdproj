...
<head>
    ...
    <body>
        ...
        @extends('Water.page.argos.component.content4')
        @extends('Water.page.argos.component.content3')
        @extends('Water.page.argos.component.content2')
        @extends('Water.page.argos.component.content')
        @extends('Water.page.argos.component.header')
