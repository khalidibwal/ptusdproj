...
<head>
    ...
    <body>
        ...
        @extends('Water.page.surface.component.content5')
        @extends('Water.page.surface.component.content4')
        @extends('Water.page.surface.component.content3')
        @extends('Water.page.surface.component.content2')
        @extends('Water.page.surface.component.content')
        @extends('Water.page.surface.component.header')
