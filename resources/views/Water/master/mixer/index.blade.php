...
<head>
    ...
    <body>
        ...
        @extends('Water.page.mixer.component.content3')
        @extends('Water.page.mixer.component.content2')
        @extends('Water.page.mixer.component.content')
        @extends('Water.page.mixer.component.header')
