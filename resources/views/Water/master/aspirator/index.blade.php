...
<head>
    ...
    <body>
        ...
        @extends('Water.page.aspirator.component.content3')
        @extends('Water.page.aspirator.component.content2')
        @extends('Water.page.aspirator.component.content')
        @extends('Water.page.aspirator.component.header')
