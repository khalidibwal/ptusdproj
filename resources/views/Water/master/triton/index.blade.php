...
<head>
    ...
    <body>
        ...
        @extends('Water.page.triton.component.content7')
        @extends('Water.page.triton.component.content6')
        @extends('Water.page.triton.component.content5')
        @extends('Water.page.triton.component.content4')
        @extends('Water.page.triton.component.content3')
        @extends('Water.page.triton.component.content2')
        @extends('Water.page.triton.component.content')
        @extends('Water.page.triton.component.header')
