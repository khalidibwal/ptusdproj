...
<head>
    ...
    <body>
        ...
        @extends('Water.page.micro.component.content3')
        @extends('Water.page.micro.component.content2')
        @extends('Water.page.micro.component.content')
        @extends('Water.page.micro.component.header')
