...
<head>
    ...
    <body>
        ...
        @extends('Water.page.trioval.component.content6')
        @extends('Water.page.trioval.component.content5')
        @extends('Water.page.trioval.component.content4')
        @extends('Water.page.trioval.component.content3')
        @extends('Water.page.trioval.component.content2')
        @extends('Water.page.trioval.component.content')
        @extends('Water.page.trioval.component.header')
