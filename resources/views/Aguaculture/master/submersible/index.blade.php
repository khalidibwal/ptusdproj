...
<head>
    ...
    <body>
		...
		@extends('Aguaculture.page.submersible.component.content4')
		@extends('Aguaculture.page.submersible.component.content3')
		@extends('Aguaculture.page.submersible.component.content2')
		@extends('Aguaculture.page.submersible.component.content')
        @extends('Aguaculture.page.submersible.component.header')
