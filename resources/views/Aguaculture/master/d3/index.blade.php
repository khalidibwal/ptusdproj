...
<head>
    ...
    <body>
		...
		@extends('Aguaculture.page.d3.component.content9')
		@extends('Aguaculture.page.d3.component.content8')
		@extends('Aguaculture.page.d3.component.content7')
		@extends('Aguaculture.page.d3.component.content6')
		@extends('Aguaculture.page.d3.component.content5')
		@extends('Aguaculture.page.d3.component.content4')
		@extends('Aguaculture.page.d3.component.content3')
		@extends('Aguaculture.page.d3.component.content2')
		@extends('Aguaculture.page.d3.component.content')
        @extends('Aguaculture.page.d3.component.header')
