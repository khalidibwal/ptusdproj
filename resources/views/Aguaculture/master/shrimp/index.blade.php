...
<head>
    ...
    <body>
		...
		@extends('Aguaculture.page.shrimp.component.content7')
		@extends('Aguaculture.page.shrimp.component.content6')
		@extends('Aguaculture.page.shrimp.component.content5')
		@extends('Aguaculture.page.shrimp.component.content4')
		@extends('Aguaculture.page.shrimp.component.content3')
		@extends('Aguaculture.page.shrimp.component.content2')
		@extends('Aguaculture.page.shrimp.component.content')
        @extends('Aguaculture.page.shrimp.component.header')
