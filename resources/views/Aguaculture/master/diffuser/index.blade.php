...
<head>
    ...
    <body>
		...
		@extends('Aguaculture.page.diffuser.component.content4')
		@extends('Aguaculture.page.diffuser.component.content3')
		@extends('Aguaculture.page.diffuser.component.content2')
		@extends('Aguaculture.page.diffuser.component.content')
        @extends('Aguaculture.page.diffuser.component.header')
