...
<head>
    ...
    <body>
        ...
        @extends('Aguaculture.page.aire2.component.content9')
        @extends('Aguaculture.page.aire2.component.content8')
        @extends('Aguaculture.page.aire2.component.content7')
        @extends('Aguaculture.page.aire2.component.content6')
        @extends('Aguaculture.page.aire2.component.content5')
        @extends('Aguaculture.page.aire2.component.content4')
        @extends('Aguaculture.page.aire2.component.content3')
        @extends('Aguaculture.page.aire2.component.content2')
        @extends('Aguaculture.page.aire2.component.content')
        @extends('Aguaculture.page.aire2.component.header')
